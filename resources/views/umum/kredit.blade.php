...
@section('content')
        ...
        <section class="py-4" style="padding-top : 64px !important">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <p class="responsive-font-ex">Beli Mobil Secara Kredit Dibantu Sales Profesional Dan Dijamin Proses Aman, Cepat, Tanpa Ribet, Syarat Mudah Dan Approve 100% Dari Leasing.</p>
                <p class="responsive-font-ex"><a href="{{url('/umum/harga')}}" class="text-danger">Lihat Harga Terbaru OTR</a></p>
